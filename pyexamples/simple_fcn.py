...
arch = [ 
    ...
    *block_3ConvPool( name='b5', botton='pool_b4', top='pool_b5', s_filer='I/16',  n_filer=(256,256,256), offset="(1,0,0)", size=(12,12,5.5), opacity=0.5,caption='conv5'),
    ...
    to_DeConv( name='dc_b5', s_filer='I/8', n_filer=(16), offset="(0.5,0,0)", to="(c_b5-east)", width=2, height=16, depth=16, caption=''),
    ...
    to_side( of='pool_b4', to='c_b4', of_offset = 0.5 , of_width = 1, to_width = 2, offset = 6.4),

    to_plus(name = 'plus_b4', to='(dc_b5-east)', offset='(1,0,0)'),
    to_connection('dc_b5','plus_b4'),
    to_sidetop('c_b4','plus_b4', of_width=2, offset = 1),

    ########################################### ASPP
    # Path B
    to_Conv( name='aspp_b1', s_filer='', n_filer=32, offset="(1,3,0)", to="(plus_b4-east)", width=2.5, height=16, depth=16, caption='dilation_rate 6'),
    to_Conv( name='aspp_b2', s_filer='', n_filer=32, offset="(0,0,0)", to="(aspp_b1-east)", width=2.5, height=16, depth=16, caption=''),
    ...
    to_side( of='plus_b4', to='aspp_b1', of_offset = 0.1 , of_width = 5, to_width = 2.5, offset = 1),

    # Path C
    to_Conv( name='aspp_c1', s_filer='', n_filer=32, offset="(1,-3,0)", to="(plus_b4-east)", width=2.5, height=16, depth=16, caption=''),
    to_Conv( name='aspp_c2', s_filer='', n_filer=32, offset="(0,0,0)", to="(aspp_c1-east)", width=2.5, height=16, depth=16, caption=''),
    to_Conv( name='aspp_c3', s_filer='', n_filer=32, offset="(0,0,0)", to="(aspp_c2-east)", width=2.5, height=16, depth=16, caption='dilation_rate 6'),
    to_Conv( name='aspp_c4', s_filer='I/8', n_filer=16, offset="(0,0,0)", to="(aspp_c3-east)", width=2, height=16, depth=16, caption=''),
    to_side( of='plus_b4', to='aspp_c1', of_offset = 0.1 , of_width = 5, to_width = 2.5, offset = 1),
